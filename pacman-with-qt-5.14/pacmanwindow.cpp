...
void PacmanWindow::Fct_affichageScore(){
  ...
  if (jeu.multiOnOff == false){
    affi_scoreJ2->setFrameStyle(QFrame::NoFrame);
    affi_scoreJ2->clear();
    affi_scoreJ2->setStyleSheet("QLabel { background-color : rgba(0,0,0,0%) }");
  }
...
void PacmanWindow::Fct_affichageVie(){
  ...
  if (jeu.multiOnOff == false){
    affi_vieJ2->setFrameStyle(QFrame::NoFrame);
    affi_vieJ2->clear();
    affi_vieJ2->setStyleSheet("QLabel { background-color : rgba(0,0,0,0%) }");
  }
